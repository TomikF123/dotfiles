...
awful.layout.layouts                   = {
    ...
    --awful.layspiralout.suit.spiral.dwindle,
...
-- -- GPT4 helping of keyboard layout problem
...
-- Destroy all notifications
    ...
    --- Screenshot
    awful.key({}, "Print", function() awful.util.spawn("ksnip -a") end),
    awful.key({ altkey }, "Print", function() awful.util.spawn("ksnip -c") end),
